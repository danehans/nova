...
class HostManagerTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.fake_instances = fakes.INSTANCES
        self.fake_compute_nodes = fakes.COMPUTE_NODES
    ...
    def test_get_all_host_states(self):
        ...
        db.compute_node_get_all(context).AndReturn(self.fake_compute_nodes)
        # Invalid service
        logging.warn(mox.IgnoreArg())
        db.instance_get_all(context).AndReturn(self.fake_instances)
