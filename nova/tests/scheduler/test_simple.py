...
from nova.tests.scheduler import test_chance
...
class SimpleSchedulerTestCase(test_chance.ChanceSchedulerTestCase):
    ...
    def test_schedule_instance_last_host_gets_instance(self):
        ...
        because the DB query returns list of services sorted by cores
        with smallest cores first.
        """
        self.flags(max_cores=10)
