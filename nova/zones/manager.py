...
class ZonesManager(manager.Manager):
    ...
    def instance_destroy(self, context, instance_info, routing_path=None,
        ...
        instance_uuid = instance_info['uuid']
        try:
            self.db.instance_destroy_by_uuid(context, instance_uuid)
