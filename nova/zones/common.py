...
FLAGS = flags.FLAGS
LOG = logging.getLogger('nova.zones.common')


def form_routing_message(dest_zone_name, direction, method,
...
def form_instance_update_broadcast_message(instance):
    ...
    update_fields = ['uuid', 'vm_state', 'task_state', 'host',
            'project_id', 'user_id', 'progress', 'image_ref']
    instance_info = {}
    for key in update_fields:
        if key in instance:
            instance_info[key] = instance[key]
